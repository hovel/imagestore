...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImagestoreAlbumImagePtr'
        db.create_table('cmsplugin_imagestorealbumimageptr', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imagestore.Image'])),
        ))
        db.send_create_signal('imagestore_cms', ['ImagestoreAlbumImagePtr'])

    def backwards(self, orm):
        # Deleting model 'ImagestoreAlbumImagePtr'
        db.delete_table('cmsplugin_imagestorealbumimageptr')
    ...
    models = {
        ...
        'imagestore_cms.imagestorealbumcarousel': {
            ...
            'template_file': ('django.db.models.fields.CharField', [], {'default': "'cms/plugins/imagestore_album_carousel.html'", 'max_length': '100', 'blank': 'True'})
        },
        'imagestore_cms.imagestorealbumimageptr': {
            'Meta': {'object_name': 'ImagestoreAlbumImagePtr', 'db_table': "'cmsplugin_imagestorealbumimageptr'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
