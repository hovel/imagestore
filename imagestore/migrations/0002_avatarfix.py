...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.is_public'
        db.add_column('imagestore_category', 'is_public', orm['imagestore.category:is_public'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Category.is_public'
        db.delete_column('imagestore_category', 'is_public')
